...
class woo_multi_tab_product extends Widget_Base {

    public function get_name()
    {
        return 'velanto-tab-product';
    }

    public function get_title()
    {
        return __('Tab Product', 'velanto');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => woo_multi_product_cat('produkte_category'),
                'multiple' => true,
                'label_block' => true,
            ]
        );
...
Plugin::instance()->widgets_manager->register(new woo_multi_tab_product());